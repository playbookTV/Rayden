    ...
    return (
      ...
      >
        ...
        >
          ...
          {hasConnectorAbove && (
            <div className="h-2 w-px bg-grey-100" />
          )}
          ...
          {hasConnectorBelow && (
            <div className="flex-1 w-px bg-grey-100" />
          )}
        </div>
          ...
          <div className="flex flex-col gap-1 w-full">
            ...
            <div className="flex items-center justify-between w-full">
              <div className="flex flex-1 items-start gap-1 min-w-0">
                <span className="text-body-sm leading-5 text-grey-600">
                  {text}
                </span>
              </div>
              {unread && (
            ...
            {(date || time || link || badge) && (
              <div className="flex items-start gap-1 w-full">
                ...
                {time && (
                  <span className="shrink-0 text-xs text-grey-400 whitespace-nowrap">
                    {time}
                  </span>
                )}
              </div>
