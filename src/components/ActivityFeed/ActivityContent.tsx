        ...
        >
          ...
          <div className="flex flex-col items-start">
            <div className="flex items-center gap-1">
              <span className="text-xs font-semibold text-grey-700 whitespace-nowrap">
                {title}
              </span>
              {size && (
                <>
    ...
    if (variant === "comment") {
      ...
      const commentContent = (
        <>
          ...
          {/* Comment body */}
          {comment && (
            <p className="text-body-sm text-grey-600 leading-5">{comment}</p>
          )}
          ...
          {attachments && attachments.length > 0 && (
            <div className="flex items-start gap-2">
              ...
              {attachments.length > 2 && (
                <div className="flex items-center justify-center size-8 rounded-lg border border-grey-100 bg-white px-2 py-1">
          ...
          {(reactions != null || replies != null) && (
            <div className="flex items-start gap-2">
              {reactions != null && (
                <div className="flex items-center gap-2 rounded-lg border border-grey-100 bg-white px-2 py-1">
              ...
              {replies != null && (
                <div className="flex items-center gap-2 rounded-lg border border-grey-100 bg-white px-2 py-1 h-8">
      ...
      if (contentStyle === "plain") {
        return (
          ...
          >
            ...
            <div className="flex flex-col gap-2 items-start rounded-lg p-3">
              {commentContent}
            </div>
          </div>
        );
