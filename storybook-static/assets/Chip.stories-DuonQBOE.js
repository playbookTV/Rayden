import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as f}from"./iframe-g5PiM8Jh.js";import{c as u}from"./cn-C8nBGPD0.js";import{r as b}from"./resolveIcon-B4eesLNI.js";import{I as v}from"./Icon-CxPrjGB-.js";import"./preload-helper-PPVm8Dsz.js";const a=f.forwardRef(({variant:o="input",icon:m,disabled:l=!1,onClose:s,onDropdown:c,className:d,children:p,...h},g)=>e.jsxs("div",{ref:g,className:u("inline-flex items-center gap-1 rounded-md border px-2 py-1 text-sm font-medium transition-colors",l?"border-grey-200 bg-grey-100 text-grey-300 cursor-not-allowed":"border-grey-300 bg-white text-grey-700 cursor-default focus-within:bg-[#FBF1F1] focus-within:border-primary-600",d),...h,children:[m&&e.jsx("span",{className:"shrink-0 size-4",children:b(m,"sm")}),e.jsx("span",{children:p}),o==="input"&&s&&e.jsx("button",{type:"button",onClick:s,disabled:l,className:u("shrink-0 size-4 inline-flex items-center justify-center rounded-sm",l?"cursor-not-allowed text-grey-300":"cursor-pointer text-grey-500 hover:text-grey-700"),"aria-label":"Remove",children:e.jsx(v,{name:"multiply",size:"xs"})}),o==="filter"&&e.jsx("button",{type:"button",onClick:c,disabled:l,className:u("shrink-0 size-4 inline-flex items-center justify-center",l?"cursor-not-allowed text-grey-300":"cursor-pointer text-grey-500 hover:text-grey-700"),"aria-label":"Open filter",children:e.jsx(v,{name:"chevron-down",size:"xs"})})]}));a.displayName="Chip";a.__docgenInfo={description:"",methods:[],displayName:"Chip",props:{variant:{required:!1,tsType:{name:"union",raw:'"input" | "filter"',elements:[{name:"literal",value:'"input"'},{name:"literal",value:'"filter"'}]},description:"",defaultValue:{value:'"input"',computed:!1}},icon:{required:!1,tsType:{name:"union",raw:"ReactNode | IconName",elements:[{name:"ReactNode"},{name:"union",raw:`"3d"
| "AI-stars"
| "AR"
| "BTC"
| "ETH"
...
}`,...i.parameters?.docs?.source}}};const N=["InputChip","FilterChip","Disabled"];export{i as Disabled,r as FilterChip,n as InputChip,N as __namedExportsOrder,I as default};
