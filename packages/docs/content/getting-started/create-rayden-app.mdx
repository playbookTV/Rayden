---
title: create-rayden-app
description: Scaffold a new Rayden UI project with one command
---

# create-rayden-app

The fastest way to start a new project with Rayden UI. Scaffold a complete React application with Rayden UI pre-configured.
...
- **Project name** — Your app's folder name
- **Framework** — Vite (recommended) or Next.js
- **Template** — Blank, Minimal, Landing, Dashboard, E-commerce, or Blog
...
- [Design Tokens](/design-tokens) — Customize colors and spacing
- [Blocks](/blocks) — Add pre-built UI patterns
