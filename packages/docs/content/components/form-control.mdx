...
| `onChange`    | `ChangeEventHandler<HTMLInputElement>` | — | Native change handler; read `e.target.checked` |
...
<Preview vertical>
  <Radio name="preview-options" value="option1" label="Option 1" checked />
  <Radio name="preview-options" value="option2" label="Option 2" />
  <Radio name="preview-options" value="option3" label="Option 3" />
</Preview>
