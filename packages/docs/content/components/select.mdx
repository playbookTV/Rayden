...
<Preview>
  <Select label="Status" placeholder="Select status">
    <SelectOption value="active" statusColor="success">
      Active
    </SelectOption>
    <SelectOption value="pending" statusColor="warning">
      Pending
    </SelectOption>
    <SelectOption value="inactive" statusColor="error">
      Inactive
    </SelectOption>
  </Select>
</Preview>
...
<Select label="Category" value={value} onValueChange={setValue}>
