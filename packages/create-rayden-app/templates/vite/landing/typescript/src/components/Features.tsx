...
const features = [
  {
    ...
    description:
      "Pre-built, accessible components that follow best practices and design standards.",
    icon: "grid" as const,
  },
  {
    name: "Design Tokens",
        ...
        <div className="mx-auto mt-16 max-w-5xl">
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {features.map((feature) => (
              <div
                key={feature.name}
                className="relative p-6 rounded-2xl bg-grey-50 hover:bg-grey-100 transition-colors"
              >
