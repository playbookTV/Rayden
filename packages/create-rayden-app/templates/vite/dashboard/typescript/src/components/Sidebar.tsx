...
import { SidebarMenu, SidebarMenuItem, SidebarMenuSection, Avatar } from "@raydenui/ui";
...
export default function Sidebar() {
  ...
  const currentValue = location.pathname.replace("/", "") || "dashboard";
      ...
      <div className="absolute bottom-0 left-0 w-64 p-4 border-t border-grey-200">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm font-medium text-grey-900 truncate">John Doe</p>
