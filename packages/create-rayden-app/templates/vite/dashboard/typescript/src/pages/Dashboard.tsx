  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-grey-600 mt-1">Welcome back! Here's an overview of your account.</p>
      </div>
      ...
      <div className="bg-white rounded-xl border border-grey-200 p-6">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-lg font-semibold text-grey-900">Recent Activity</h2>
        ...
        <div className="space-y-4">
          {[
            ...
            >
              ...
              {item.amount && (
                <span className="text-sm font-medium text-grey-900">{item.amount}</span>
              )}
            </div>
          ))}
        </div>
