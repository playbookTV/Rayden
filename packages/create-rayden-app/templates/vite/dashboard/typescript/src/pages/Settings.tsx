  ...
  return (
    <div className="space-y-6 max-w-2xl">
      <div>
        ...
        <p className="text-grey-600 mt-1">Manage your account settings and preferences.</p>
      </div>
      ...
      <div className="bg-white rounded-xl border border-grey-200 p-6 space-y-6">
        <div>
          ...
          <div className="grid gap-4">
            ...
            <Input label="Email" type="email" defaultValue="john@example.com" size="md" />
          </div>
        </div>
        ...
        <div>
          <h2 className="text-lg font-semibold text-grey-900 mb-4">Notifications</h2>
