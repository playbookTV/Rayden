  ...
  if (cartItems.length === 0) {
    return (
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 text-center">
        <h1 className="text-2xl font-bold text-grey-900 mb-4">Your cart is empty</h1>
        <Link to="/products">
        ...
        <div className="grid gap-8 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              <h2 className="text-lg font-semibold text-grey-900 mb-4">Contact Information</h2>
              <div className="grid gap-4 sm:grid-cols-2">
                <Input placeholder="Email" type="email" required className="sm:col-span-2" />
            ...
            {/* Shipping Address */}
            <div className="bg-white rounded-xl shadow-sm p-6">
              <h2 className="text-lg font-semibold text-grey-900 mb-4">Shipping Address</h2>
              <div className="grid gap-4 sm:grid-cols-2">
            ...
            {/* Payment */}
            <div className="bg-white rounded-xl shadow-sm p-6">
              <h2 className="text-lg font-semibold text-grey-900 mb-4">Payment</h2>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl shadow-sm p-6 sticky top-24">
              <h2 className="text-lg font-semibold text-grey-900 mb-4">Order Summary</h2>
                ...
                {cartItems.map((item) => (
                  <div key={item.id} className="flex gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-sm font-medium text-grey-900 truncate">{item.name}</p>
              ...
              <div className="flex justify-between mb-6">
                ...
                <span className="font-bold text-xl text-grey-900">{formatPrice(total)}</span>
              </div>
