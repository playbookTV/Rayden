...
const tiers = [
  {
    ...
    features: ["All core components", "Community support", "Basic documentation", "MIT License"],
    cta: "Get Started",
    featured: false,
  },
  {
        ...
        <div className="mx-auto mt-16 grid max-w-5xl grid-cols-1 gap-8 lg:grid-cols-3">
          {tiers.map((tier) => (
            ...
            >
              ...
              <h3
                className={`text-xl font-semibold ${tier.featured ? "text-white" : "text-grey-900"}`}
              >
                {tier.name}
              </h3>
              <div className="mt-4 flex items-baseline gap-1">
                <span
                  className={`text-4xl font-bold ${tier.featured ? "text-white" : "text-grey-900"}`}
                >
                  {tier.price}
                </span>
                {tier.period && (
