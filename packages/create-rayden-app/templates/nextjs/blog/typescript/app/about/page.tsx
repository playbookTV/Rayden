    ...
    <div className="bg-white rounded-xl shadow-sm overflow-hidden">
      <div className="p-8">
        ...
        <p className="text-grey-600 mb-8">
          Welcome to the Rayden UI blog! This is where we share tutorials, guides, and insights
          about building beautiful user interfaces with our component library.
        </p>
        ...
        <div className="grid gap-6 sm:grid-cols-2">
          {Object.values(authors).map((author) => (
            <div key={author.initials} className="flex items-start gap-4 p-4 rounded-xl bg-grey-50">
